$(document).ready(function()
{
  ...
  $(document).on('click', '#btn_cat_save', function()
  {
    ...
    var practice_uuid = getCookie('practice_uuid');


    // Controleren of alles is ingevuld
    if(cat_name != '' && cat_description != '')
    {
      $.post('api/api.php?action=addFlowchartCategory', {practice_id:practice_uuid, category_title:cat_title, category_description:cat_description}, function(result)
      {
